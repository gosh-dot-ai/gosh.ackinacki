...
// Public multisig-wallet deployment (issue gosh-dot-ai/gosh.ackinacki#5): deploy
// a funding wallet of an explicitly chosen version, surfaced at the crate root so
// consumers do not have to hunt for it.
pub use wallet::multisig::{deploy_multisig, DeployMultisigParams, FundingSource, MultisigKind};
