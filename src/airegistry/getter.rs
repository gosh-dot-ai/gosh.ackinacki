...
fn parse_messages_page(
    ...
    for e in edges {
        ...
        let Ok(event) = crate::airegistry::events::decode_event_body_b64(contract, b) else {
            continue;
        };
...
/// One decoded event with its on-chain identity and pagination cursor.
#[derive(Debug, Clone)]
pub struct EventRecord {
    pub event: crate::airegistry::events::AiRegistryEvent,
...
impl AccountReader {
    ...
    pub async fn read_events(
        ...
        parse_messages_page(&resp, address, &contract)
    }
